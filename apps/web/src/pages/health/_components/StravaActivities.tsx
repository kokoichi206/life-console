...
export const StravaActivities = ({ from, to, weights, meals, onSelectWeek }: {
  ...
  return (
    <Panel className="mb-6 gap-4 px-5" aria-label="Strava の運動記録">
      <header className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-xl font-semibold">運動と週の振り返り</h2>
      ...
      {weeks.length > 0 && (
        <>
          <p className="text-xs text-muted-foreground">週を選ぶと、その週の体重・運動・食事に絞れます。平均体重は期間内の実測値から算出しています。</p>
