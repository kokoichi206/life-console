...
export const snapWeightWindow = (window: WeightWindow): WeightWindow => ({
  start: Math.round(window.start / WEIGHT_DAY_MS) * WEIGHT_DAY_MS,
  end: Math.round(window.end / WEIGHT_DAY_MS) * WEIGHT_DAY_MS,
});
