...
import { normalizeMealPhoto } from "../image";
import { mealsQuery, weightsQuery } from "../query";
    ...
    <>
      ...
      <section className="mb-6">
        <header className="mb-4 flex items-end justify-between gap-6 max-md:flex-col max-md:items-start">
          ...
          <div className="flex flex-wrap gap-1 rounded-lg border bg-card p-1" aria-label="表示期間">
