...
export const runnerEnvironmentSchema = baseEnvSchema.extend({
  ...
  LIFE_CONSOLE_NUTRITION_PROVIDER: z.enum(["codex", "claude", "gemini"]).default("codex"),
  LIFE_CONSOLE_NUTRITION_MODEL: z.string().min(1).optional(),
  GEMINI_API_KEY: z.string().min(1).optional(),
  GEMINI_CLI_HOME: z.string().min(1).optional(),
